...
export default {
  ...
  data() {
    return {
      ...
      paymentMethods: [
        { id: 'xzpay', name: '穴汁支付', icon: '/images/xzpay.png' },
        { id: 'pypay', name: '屁眼支付', icon: '/images/pypay.png' },
        { id: 'qqpay', name: 'Q币支付', icon: '/images/qqpay.png' }
      ],
      message: '',
      messageType: ''
    }
  ...
  methods: {
    ...
    handleDeposit() {
      ...
      if (users[username]) {
        ...
        this.userBalance = users[username].balance
